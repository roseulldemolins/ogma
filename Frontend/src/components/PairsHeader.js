...
const PairsHeader = ({ restartGame }) => (
  <div className="grid-header-container">
    ...
    <button onClick={restartGame} className="pairs-button">Start New Game</button>
    <button className="pairs-button" type="button" data-toggle="modal" data-target="#flashcardsModal">Instructions</button>
    </div>
    </div>
